...
namespace metalAssistor.server
{
    public class Util
    {
		...
		public static DateTime TimeConvert(string time)
        {
            try
            {
				DateTime dt;
				DateTimeFormatInfo dtFormat = new System.Globalization.DateTimeFormatInfo();
				dtFormat.ShortDatePattern = "yyyy年MM月dd日HH时mm分";
		...
		public static byte[] CRC16(byte[] data, int length)
		{
			...
			{
				crcRegister_L = (byte)(crcRegister_L ^ data[i]);
...
0x41, 0x81, 0x80, 0x40
		...
		*功能：计算CRC 校验码
		*************************************************/
		public static ushort CRC16_new(byte[] Frame, int Length)
		{
			byte CRCHi = 0xFF;
			byte CRCLo = 0xFF;
			int iIndex = 0;

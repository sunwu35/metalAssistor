...
{
    public partial class CreateGuaranteeTaskForm : Form
    {
        public CreateGuaranteeTaskForm()
        {
            InitializeComponent();
        ...
        public GuaranteeTaskBean SubTask { get => subTaskBean; set => subTaskBean = value; }
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            subTaskBean.Count = 3;
            subTaskBean.LoadTime = (float)doubleInputLoadTime.Value;
            subTaskBean.ProofLoad = (float)doubleInputPoorf.Value;
